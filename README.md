# Modified tufte-jekyll theme for remote theme

This is a modification of the tufte-jekyll theme with the new [remote theme](https://github.com/benbalter/jekyll-remote-theme). Everything else is the same as below.

# Old Tufte Jekyll content
